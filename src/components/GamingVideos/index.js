...
class GamingVideos extends Component {
  ...
  getVideos = async () => {
    ...
    if (response.ok) {
      ...
      const updatedData = data.videos.map(
        eachVideo => ({
          id: eachVideo.id,
  ...
  renderLoadingView = () => (
    <LoaderContainer data-testid="loader">
      <Loader type="ThreeDots" color="#8b69ff" height="58" width="50" />
    </LoaderContainer>
  )
    ...
    return (
      <ThemeAndVideoContext.Consumer>
        {value => {
          ...
          const textColor = isDarkTheme ? '#f9f9f9' : '#231420'
          ...
          return (
            <div>
              ...
              <GamingContainer data-testid="gaming" bgColor={bgColor}>
                ...
                (this.renderTrending Videos()) dex.js
              </GamingContainer>
            </div>
          )
        }}
